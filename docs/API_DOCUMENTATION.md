...
```json
{
	...
	"data": {
		...
		"pois_by_type": {
			...
			"planet": [{ "uuid": "planet-001", "name": "Earth", "distance": 0.5, "is_inhabited": true }],
			"asteroid_belt": [
			...
			"planets": [
				{
					...
					"moons": [{ "uuid": "moon-001", "name": "Luna", "is_inhabited": false }]
				}
			],
			"moons": [],
			"asteroid_belts": [
...
```json
{
	...
	"data": {
		...
		"salvage_available": {
			"credits": 1500,
			"cargo": [{ "mineral": "Titanium", "quantity": 20 }]
		}
	}
}
```
...
```json
{
	...
	"data": {
		"cargo_lost": [{ "mineral": "Titanium", "quantity": 50 }],
		"credits_lost": 5000,
...
```json
{
	...
	"data": {
		...
		"cargo_collected": [{ "mineral": "Titanium", "quantity": 20 }],
		"total_credits": 16500
	}
}
```
...
```json
{
	...
	"data": {
		...
		"production": {
			...
			"resources": [{ "mineral": "Titanium", "amount_per_cycle": 100 }]
		},
		"buildings": [
